 ...
 *  remove that tab. Make a breaker aura tab itself. make auto dialoug its own category as well, and make
 *  custom mage beam its own category as well." - shares {@link DungeonExtrasConfig} with
 *  {@link AutoDialogueTab} and {@link BreakerAuraTab}; the config file itself was not split. */
public class CustomMageBeamTab extends BaseTab {

    public CustomMageBeamTab() {
        super("Custom Mage Beam");
    }
