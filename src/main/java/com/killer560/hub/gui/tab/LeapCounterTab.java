 ...
 * <p>
 * Labels double as tooltip keys (label cut at ':' and lower-cased, see {@code gui/SettingTooltips}), so a few are
 * prefixed to stay clear of keys other tabs already own: "Leap Alert Sound" (not "Alert Sound"), "Counter HUD" (not
 * "HUD").
 */
public class LeapCounterTab extends BaseTab {
    ...
    public List<AbstractWidget> buildWidgets(int contentX, int contentY, int contentWidth, Runnable requestRebuild) {
        ...
        toggle(w, contentX, y[0], half, "Leap Alert Title", cfg::isAlert, cfg::setAlert, cfg);
        toggle(w, colB, y[0], half, "Leap Alert Sound", cfg::isSound, cfg::setSound, cfg);
        y[0] += 22;
        ...
        // "HUD" alone is the Score Calculator's tooltip key.
        header(w, contentX, y, contentWidth, "Counter HUD");
