...
final class SettingTooltipsData {
    ...
    private static void part1(Map<String, String> d) {
        ...
        d.put("chains file", "All chains live in one file, killer560smod-ap3.json in the config folder - one entry per boss area (P1, P2, S1-S5, P4, P5), optionally per class. Edit it in Notepad or hand it to someone as-is; paste a friend's copy in, then Reload - no restart. Files from before AP3 worked outside P3 still load: their S1-S5 chains are P3 chains.");
