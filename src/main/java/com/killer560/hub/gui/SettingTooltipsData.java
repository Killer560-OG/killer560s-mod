...
final class SettingTooltipsData {
    ...
    private static void part3(Map<String, String> d) {
        ...
        d.put("yt shorts/position", "Which corner or side of the Minecraft window the Shorts window sits in: right or left, at the top, center or bottom.");
        d.put("yt shorts/size", "Height of the Shorts window as a percent of Minecraft's window height (20-100%). Width follows the 9:16 video shape.");
        d.put("yt shorts/margin", "Gap in screen pixels (0-200) between the Shorts window and the edges of the Minecraft window.");
        d.put("yt shorts/opacity", "How see-through the Shorts window is, 20% (faint) to 100% (solid).");
        d.put("yt shorts/volume", "Shorts video volume, 0-100%. Starts on 'YouTube's own', which leaves YouTube's volume alone. Once you move the slider, there is currently no way to switch back to that setting.");
        d.put("yt shorts/theme", "Colour scheme for the Shorts window: System follows your Windows setting, Dark and Light force YouTube's theme, and Amber uses this mod's orange theme. Changes apply right away.");
        d.put("yt shorts/next", "Keybind that skips to the next Short. Works in-game only (no menu open). Press Esc while binding to clear.");
        d.put("yt shorts/previous", "Keybind that goes back to the previous Short. Works in-game only (no menu open). Press Esc while binding to clear.");
        d.put("yt shorts/mute", "Keybind that mutes or unmutes the Shorts video. Works in-game only (no menu open). Press Esc while binding to clear.");
        ...
        d.put("ap3/align tolerance", "How far off, on each axis, an Align may settle and still count as landed (default 0.001). Type an exact value in the box or drag the slider; both are saved at once. Any server position correction during AP3 movement stops it; two in ten seconds turn AP3 off.");
        d.put("ap3/align method", "How an Align lands. Camera Planner (default): two solved key taps while turning your real yaw up to 30 degrees a tick - exact, and 8/8 with no server corrections on Hypixel. Keys + Sneak: real keys and sneak taps at your camera yaw, no turning - lands within a few thousandths at high speed. Sent-Yaw Planner: the same taps under the silent server-side yaw - exact, but Hypixel corrected it; keep it for A/B tests on an alt only.");
        d.put("ap3/fast align tolerance", "How far off, on each axis, a Fast Align may settle (default 0.005). A Fast Align hands over to the next node the moment the slide you are on will stop inside this, instead of waiting until you are standing still, and never spends extra ticks refining closer.");
        d.put("ap3/freeze view while aligning", "Camera Planner only. Your screen keeps the view you had while the align turns your real yaw underneath (the server, and your model in F5, see the real one). Your mouse keeps steering the view. When the align ends your real yaw glides back under the view, and nothing on screen moves. Default ON.");
        d.put("ap3 fast align color", "Marker colour for Fast Align nodes.");
        d.put("add fast align node", "Places a Fast Align: the same exact landing as an Align but tuned for speed - it settles within Fast Align Tolerance (default 0.005) and hands over while you are still sliding to a stop.");
