...
final class SettingTooltipsData {
    ...
    private static void part1(Map<String, String> d) {
        ...
        d.put("posmsg", "Master switch for the Posmsg Waypoints HUD list (your waypoints plus ones teammates sent via party chat). Move it in the HUD editor.");
        d.put("+ add custom waypoint", "Adds a new custom waypoint to the list. Stand on the spot and use 'Set to my position' before sending it.");
        d.put("enabled", "Turns this entry on or off.");
        d.put("send", "Sends this waypoint's name, coordinates and radius to party chat so teammates with this mod see it in their HUD list.");
        d.put("set to my position", "Saves your current position as this waypoint's coordinates. Needed before it can be sent.");
        d.put("show radius", "Saved per waypoint, but currently has no visible effect (no in-world radius circle is drawn yet).");
        d.put("show display", "Lists this waypoint (name, colour and distance) in the Posmsg HUD list.");
        d.put("radius", "Distance in blocks this waypoint or route point covers.");
        d.put("only if inside", "Only lists this waypoint in the HUD while you are standing within its radius.");
