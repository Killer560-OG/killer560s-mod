...
final class SettingTooltipsData {
    ...
    private static void part3(Map<String, String> d) {
        ...
        d.put("ap3/align method", "How an Align lands. Keys + Sneak: real keys and sneak taps at your camera yaw, nothing hidden - lands within a few thousandths at high speed, exact at walking speed. Camera Planner: two solved key taps while turning your real camera up to 30 degrees a tick - exact (0.001 worst case in the harness) and nothing hidden. Sent-Yaw Planner: the same taps under the silent server-side yaw - exact, but Hypixel corrected it; keep it for A/B tests on an alt only.");
    }
}
