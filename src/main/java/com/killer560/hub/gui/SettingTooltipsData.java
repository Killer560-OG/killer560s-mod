...
final class SettingTooltipsData {
    ...
    private static void part1(Map<String, String> d) {
        ...
        d.put("posmsg", "Master switch for position messages: each waypoint draws a ring on the ground and types its own line into party chat when you walk into it.");
