...
final class SettingTooltipsData {
    ...
    private static void part3(Map<String, String> d) {
        ...
        d.put("tic tac toe solver/highlight style", "How the Tic Tac Toe square to click is drawn: Outline or Fill. Only the clickable part (the button, or the item frame) is highlighted, never the whole block.");
        ...
        d.put("ap3 fast align color", "Marker colour for Fast Align nodes (the experimental fasfast align: brakes with sneak taps at any yaw instead of coasting to a stop).");
